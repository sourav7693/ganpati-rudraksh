...
export default function CheckoutClient() {
      ...
      const options = {
        ...
        handler: async (response: RazorpayResponse) => {
          ...
          if (verifyData.success) {
            ...
            router.push(`/thank-you?payment=${paymentId}&order=${orderIds}`);
            await refreshCustomer();
          } else {
  ...
  return (
    <div className="2xl:max-w-360 lg:max-w-300 xxl:max-w-460 px-4 mx-auto grid grid-cols-1 lg:grid-cols-3 py-6 gap-6">
      {/* LEFT */}
      <div className="lg:col-span-2 space-y-2">
          ...
          <div className="flex justify-between items-center">
            ...
            {!changeAccountMode ? (
              <button
                ...
                className="text-define-black flex flex-row gap-2 items-center text-xs lg:text-sm p-1 px-3 bg-yellow-500  rounded"
              >
          ...
          {!changeAccountMode ? (
            ...
            <div className="mt-3 flex justify-between items-center">
              ...
              <button
                ...
                className="text-xs lg:text-base p-1 lg:p-2 bg-define-brown text-white rounded"
              >
                Continue Checkout
              </button>
            </div>
        ...
        <div className="flex flex-col text-define-black bg-white rounded-md p-4 mt-2">
          <div className="flex justify-between items-center">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center w-full md:w-40">
                  ...
                  <div className="md:flex hidden items-center mt-2 ">
                    <button
                      ...
                      className="px-4 py-2 border text-define-black border-gray-200 rounded-full hover:bg-gray-100"
                    >
                      −
                    </button>

                    <span className="px-4 py-1 border text-define-black border-gray-200 mx-2">
                      {item.quantity}
                    </span>
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="font-semibold text-[18px] text-define-brown">
                    ...
                    <p
                      className="mt-2 text-sm text-define-black line-clamp-1"
                    ...
                    <p className="mt-2 font-bold text-define-red text-lg">
                      ...
                      <span className="text-define-red text-[13px] ml-2 font-normal">
                  ...
                  <div className="md:flex hidden gap-4 justify-evenly md:justify-start pt-4 lg:pt-0 md:pb-2 lg:pb-0">
                    <button
                      className="font-bold hover:text-define-brown text-define-black text-sm lg:text-lg lg:px-6 lg:py-2 "
                    ...
                    <button
                      ...
                      className="font-semibold text-define-black hover:text-define-red text-sm lg:text-lg lg:px-6 lg:py-2"
                    >
                      REMOVE
                    </button>
                  </div>
                ...
                <div className="flex md:hidden items-center gap-4 mt-3 w-full">
                  ...
                  <div className="flex lg:hidden items-center border border-gray-200 rounded-md overflow-hidden h-10">
                    <button
                      ...
                      className="px-2 h-full bg-gray-50 text-define-black hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      disabled={item.quantity <= 1 || isOutOfStock}
                    >
                      −
                    </button>

                    <span className="px-3 h-full flex items-center justify-center text-sm font-semibold text-define-black border-x border-gray-200 min-w-10">
                      {item.quantity}
                    </span>
                    ...
                    <button
                      ...
                      className={`px-2 h-full transition-colors ${
                        canIncrease && !isOutOfStock
                          ? "bg-gray-50 text-define-black hover:bg-gray-200"
      ...
      ${
        isOutOfStock
          ...
          : "border-gray-300 text-define-black hover:border-define-brown hover:text-define-brown"
      }`}
                    onClick={() => handleMoveToWishlist(item)}
      ...
      ${
        isOutOfStock
          ...
          : "border-gray-300 text-define-black hover:border-red-500 hover:text-red-600 hover:bg-red-50"
      }`}
                  >
                    Remove
                  </button>
      ...
      <div className="bg-white border border-gray-200 rounded-md p-4 h-fit sticky top-24 self-start">
        <div>
          <h3 className="font-semibold text-define-black border-b border-gray-200 pb-2">
            Have a Coupon Code?
          </h3>
    ...
    ${
      appliedCoupon
        ...
        <div className="text-sm space-y-3 mt-5 text-define-black">
          ...
          <div className="flex justify-between">
            <span>Discount</span>
            <span className="text-define-red">
              -<FaRupeeSign className="inline" />
          ...
          <div className="flex justify-between font-semibold text-lg border-t border-gray-200 text-define-black pt-3">
