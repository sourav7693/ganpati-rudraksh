      ...
      <div className="self-padding">
        ...
        <div className="flex items-center justify-between mb-10">
          <h2 className="text-xl lg:text-3xl font-bold">
            Video <span className="text-define-brown">Gallery</span>
          </h2>
          ...
          <div className="hidden lg:flex items-center gap-2">
            <button
              ...
              className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300
                ${canPrev ? "border-define-brown text-define-brown hover:bg-define-brown hover:text-white" : "border-gray-200 text-gray-300 cursor-not-allowed"}`}
            >
            ...
            <button
              ...
              disabled={!canNext}
              className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all duration-300
                ${canNext ? "border-define-brown text-define-brown hover:bg-define-brown hover:text-white" : "border-gray-200 text-gray-300 cursor-not-allowed"}`}
            >
        ...
        <div className="flex lg:hidden items-center justify-center gap-4 mt-8">
          <button
            ...
            className={`w-9 h-9 rounded-full border flex items-center justify-center
              ${mobileIdx > 0 ? "border-define-brown text-define-brown" : "border-gray-200 text-gray-300"}`}
          >
          ...
          <button
            ...
            className={`w-9 h-9 rounded-full border flex items-center justify-center
              ${mobileIdx < videos.length - 1 ? "border-define-brown text-define-brown" : "border-gray-200 text-gray-300"}`}
          >
