    ...
    <div className="fixed inset-0 z-9999 bg-black/50 flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          ...
          >
            <IoMdCloseCircle className="text-gray-500" size={20} />
          </button>
        </div>
                ...
                <div key={i} className="flex gap-4 items-start relative">
                  ...
                  <div className="z-10 relative">
                    <div
                      ...
                      ${
                        step.isError
                          ...
                          : step.completed
                            ? "bg-define-red border-define-red"
                            : step.active
                              ? "border-define-red bg-white"
                    ...
                    >
                      ...
                      {step.isError && (
                        <IoMdCloseCircle size={12} className="text-white" />
                      )}
                    </div>
        ...
        <div className="px-5 py-4 border-t border-gray-200">
          ...
          <button
            onClick={onClose}
            className="w-full px-4 py-2 bg-define-brown text-white rounded-md"
          >
            Close Tracking
          </button>
        </div>
